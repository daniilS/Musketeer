...
#define MyAppName "Musketeer"
#define MyName "Daniil Soloviev"
#define MyAppURL "https://github.com/daniilS/Musketeer"
#define MyAppExeName "Musketeer.exe"
#define MyAppAssocName MyAppName + " Fit File"
#define MyAppAssocExt ".fit"
#define MyAppAssocKey StringChange(MyAppAssocName, " ", "") + MyAppAssocExt

[Setup]
; NOTE: The value of AppId uniquely identifies this application. Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{C327C15B-6058-313C-AADF-E979233602A5}
AppName={#MyAppName}
